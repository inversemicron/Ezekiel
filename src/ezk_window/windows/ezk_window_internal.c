...
static ezk_event translate_event(MSG msg) {
  ...
  switch (msg.message) {
    ...
    case WM_MOUSEMOVE:
      ...
      ev.mousemove.mouse_pos = (ezk_v2i) {GET_X_LPARAM(msg.lParam), GET_Y_LPARAM(msg.lParam)};
      break;
    case WM_SETFOCUS:
    ...
    case WM_SIZE:
      ...
      ev.dimension.dims = (ezk_v2i) {LOWORD(msg.lParam), HIWORD(msg.lParam)};
      break;
    default:
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg,WPARAM wParam, LPARAM lParam) {
  // minimal WindowProc, events are processed separately
  switch (msg) {
    case WM_DESTROY:
      PostQuitMessage(0); // no, I don't know what this does
      return 0;
    case WM_CLOSE:
